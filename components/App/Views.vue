...
<template>
  <div class="p-6">
    ...
    <div
      v-else-if="
        searchQuery || selectedDate || selectedTag || (showStarredItems && !selectedItem)
      "
    >
      ...
      <div
        v-if="items.length <= 0"
        class="flex flex-col items-center justify-center h-64 text-center p-8 border border-dashed border-gray-700 rounded-lg"
      >
        ...
        >
          ...
          <div class="p-4">
            ...
            <UCard :ui="{ body: { padding: 'p-0 sm:p-0' } }">
              ...
              <pre
                class="p-3 text-xs font-mono overflow-hidden max-h-20 truncate"
              >
                {{ item.data }}
                </pre
              >
